...
public class ProductToCommunityController {
    ...
    public ProductToCommunity add(@PathVariable String communityId, @RequestBody ProductToCommunity PtoC) {
    ...
    public ProductToCommunity updateQuantity(@PathVariable String communityId, @PathVariable String productId, @RequestBody QuantityDto QDto) {
        if (QDto.getQte() <= 0) {
    ...
    public String delete(@PathVariable String productEanCode, @PathVariable String communityId) {
    ...
    public String massDelete(@RequestBody List<String> codes, @PathVariable String communityId) {
        if (codes.isEmpty()) {
